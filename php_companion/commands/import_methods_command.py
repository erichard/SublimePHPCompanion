...
class ImportMethodsCommand(sublime_plugin.TextCommand):
    ...
    def on_done(self, index):
        ...
        self.view.run_command("find_methods", {"path": self.files[index]})
    ...
    def run(self, edit):
        ...
        if (len(self.files) == 1):
            self.view.run_command("find_methods", {"path": self.files[0]})
